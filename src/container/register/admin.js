        ...
        <Sider collapsible collapsed={collapsed} onCollapse={this.onCollapse}>
          ...
          >
            ...
            <Menu.Item
              key='2'
              icon={<TeamOutlined />}
              onClick={() => this.setState({ panelId: 2 })}
            >
              User
            </Menu.Item>
            <Menu.Item key='3' onClick={() => this.setState({ panelId: 3 })}>
              All Grids
            </Menu.Item>
            <Menu.Item key='4' onClick={() => this.setState({ panelId: 4 })}>
              Requestes
            </Menu.Item>
            <Menu.Item
              key='5'
              icon={<UserOutlined />}
              onClick={() => this.setState({ panelId: 5 })}
            >
              Admin Profile
            </Menu.Item>
            <Menu.Item
